...
const ChatRoom = () => {
  ...
  const [messages, setMessages] = useState([
    {
      content:
        "Hello, I am Tera Consult, your virtual blockchain assistant <Telos>. How can I help you...",
      role: "assistant",
    },
  ]);
      ...
      const temp = [
        {
          role: "user",
          content:
            "You are Tera Consult, my assistant and I want you to assume the role of my blockchain cosultant as I want to know more about blockchain, the Ethereum blockchain and Telos in particular. I understand the advice you give me shouldn't be financial advice. I need just short messages/advice. Engage me in a conversation.",
        },
        ...messages,
